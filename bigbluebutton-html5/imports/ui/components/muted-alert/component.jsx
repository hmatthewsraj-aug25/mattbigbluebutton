  ...
  render() {
    ...
    return visible && muted ? (
      ...
      >
        ...
        >
          <span>
            {intl.formatMessage(intlMessages.warningLabel, { unmuteIcon: <><span className="sr-only">{intl.formatMessage(intlMessages.unmuteAudio)}</span><Icon iconName="mute" aria-hidden="true" /></> })}
          </span>
        </Styled.MuteWarning>
      </TooltipContainer>
    ) : null;
